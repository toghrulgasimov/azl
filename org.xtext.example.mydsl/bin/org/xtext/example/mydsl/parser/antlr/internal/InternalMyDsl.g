...
@after {
	...
	(
		otherlv_0='yigim'
		{
			newLeafNode(otherlv_0, grammarAccess.getPackageDeclarationAccess().getYigimKeyword_0());
		}
		(
			(
				{
...
@after {
	...
	(
		otherlv_0='sinif'
		{
			newLeafNode(otherlv_0, grammarAccess.getEntityAccess().getSinifKeyword_0());
		}
		(
			(
				{
		...
		(
			otherlv_2='varis'
			{
				newLeafNode(otherlv_2, grammarAccess.getEntityAccess().getVarisKeyword_2_0());
			}
			(
				(
					{
...
@after {
	...
	(
		otherlv_0='funksiya'
		{
			newLeafNode(otherlv_0, grammarAccess.getOperationAccess().getFunksiyaKeyword_0());
		}
		(
			(
				{
...
@after {
	...
	(
		...
		otherlv_1='tekrar'
		{
			newLeafNode(otherlv_1, grammarAccess.getXWhileExpressionAccess().getTekrarKeyword_1());
		}
		otherlv_2='('
		{
	...
	(
		(
			...
			(
				...
				otherlv_1='dovr'
				{
					newLeafNode(otherlv_1, grammarAccess.getXForLoopExpressionAccess().getDovrKeyword_0_0_1());
				}
				otherlv_2='('
				{
...
@after {
	...
	(
		...
		otherlv_1='dovr'
		{
			newLeafNode(otherlv_1, grammarAccess.getXBasicForLoopExpressionAccess().getDovrKeyword_1());
		}
		otherlv_2='('
		{
...
@after {
	...
	(
		...
		(
			(
				(
					lv_writeable_1_0='deyisen'
					{
						newLeafNode(lv_writeable_1_0, grammarAccess.getXVariableDeclarationAccess().getWriteableDeyisenKeyword_1_0_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getXVariableDeclarationRule());
						}
						setWithLastConsumed($current, "writeable", lv_writeable_1_0 != null, "deyisen");
					}
				)
			)
			    |
			otherlv_2='verilen'
			{
				newLeafNode(otherlv_2, grammarAccess.getXVariableDeclarationAccess().getVerilenKeyword_1_1());
			}
		)
		(
			(
...
@after {
	...
	(
		otherlv_0='daxilet'
		{
			newLeafNode(otherlv_0, grammarAccess.getXImportDeclarationAccess().getDaxiletKeyword_0());
		}
		(
			(
				(
...
@after {
	...
	(
		...
		otherlv_1='qaytar'
		{
			newLeafNode(otherlv_1, grammarAccess.getXReturnExpressionAccess().getQaytarKeyword_1());
		}
		(
			('extends' | 'static' | 'import' | 'extension' | '!' | '-' | '+' | 'yeni' | '{' | 'switch' | 'synchronized' | '<' | 'super' | '#' | '[' | 'dogru' | 'yanlis' | 'null' | 'typeof' | 'eger' | 'dovr' | 'tekrar' | 'do' | 'throw' | 'qaytar' | 'try' | '(' | RULE_ID | RULE_HEX | RULE_INT | RULE_DECIMAL | RULE_STRING)=>
			(
				{
...
@after {
	...
	(
		...
		otherlv_1='eger'
		{
			newLeafNode(otherlv_1, grammarAccess.getXIfExpressionAccess().getEgerKeyword_1());
		}
		otherlv_2='('
		{
		...
		(
			(
				...
				otherlv_6='yoxsa'
				{
					newLeafNode(otherlv_6, grammarAccess.getXIfExpressionAccess().getYoxsaKeyword_6_0());
				}
			)
			(
				(
...
@after {
	...
	(
		...
		otherlv_1='yeni'
		{
			newLeafNode(otherlv_1, grammarAccess.getXConstructorCallAccess().getYeniKeyword_1());
		}
		(
			(
				{
...
@after {
	...
	(
		...
		(
			otherlv_1='dogru'
			{
				newLeafNode(otherlv_1, grammarAccess.getXBooleanLiteralAccess().getDogruKeyword_1_0());
			}
			    |
			(
				(
					lv_isTrue_2_0='yanlis'
					{
						newLeafNode(lv_isTrue_2_0, grammarAccess.getXBooleanLiteralAccess().getIsTrueYanlisKeyword_1_1_0());
					}
					{
						if ($current==null) {
							$current = createModelElement(grammarAccess.getXBooleanLiteralRule());
						}
						setWithLastConsumed($current, "isTrue", lv_isTrue_2_0 != null, "yanlis");
					}
				)
			)
		)
		...
		(
			...
			lv_importDeclarations_0_0=ruleXImportDeclaration
			{
				...
				add(
					...
					"org.xtext.example.mydsl.MyDsl.XImportDeclaration");
				afterParserOrEnumRuleCall();
			}
		)
	)+
